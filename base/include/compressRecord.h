...
#define compressRecordOUSE	57
#define compressRecordBPTR	58
#define compressRecordSPTR	59
#define compressRecordWPTR	60
#define compressRecordINPN	61
#define compressRecordCVB	62
#define compressRecordINX	63
#endif /*INCcompressH*/
...
static int compressRecordSizeOffset(dbRecordType *pdbRecordType)
{
  ...
  pdbRecordType->papFldDes[57]->size=sizeof(prec->ouse);
  pdbRecordType->papFldDes[57]->offset=(short)((char *)&prec->ouse - (char *)prec);
  pdbRecordType->papFldDes[58]->size=sizeof(prec->bptr);
  pdbRecordType->papFldDes[58]->offset=(short)((char *)&prec->bptr - (char *)prec);
  pdbRecordType->papFldDes[59]->size=sizeof(prec->sptr);
  pdbRecordType->papFldDes[59]->offset=(short)((char *)&prec->sptr - (char *)prec);
  pdbRecordType->papFldDes[60]->size=sizeof(prec->wptr);
  pdbRecordType->papFldDes[60]->offset=(short)((char *)&prec->wptr - (char *)prec);
  pdbRecordType->papFldDes[61]->size=sizeof(prec->inpn);
  pdbRecordType->papFldDes[61]->offset=(short)((char *)&prec->inpn - (char *)prec);
  pdbRecordType->papFldDes[62]->size=sizeof(prec->cvb);
  pdbRecordType->papFldDes[62]->offset=(short)((char *)&prec->cvb - (char *)prec);
  pdbRecordType->papFldDes[63]->size=sizeof(prec->inx);
  pdbRecordType->papFldDes[63]->offset=(short)((char *)&prec->inx - (char *)prec);
